"""PSP outbound Admin JSON commands. Mapping in, Mapping out."""
...
def register_admin(runtime: ExtensionRuntime, engine: Any) -> None:
    runtime.admin.register("psp-outbound.charge", _wrap(engine.charge))
    runtime.admin.register(
        "psp-outbound.get",
        _wrap(lambda payload: engine.get_charge(_require_id(payload, field="payment_id"))),
    )
