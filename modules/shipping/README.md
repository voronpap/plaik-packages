...
Official PLAIK shipping module 1.0.0. Provides `shipping.methods`. Method identity is `(store_id, method_id)`. Quote is flat/manual from the stored method amount. There are no live carrier APIs.
