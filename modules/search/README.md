...
Official PLAIK search/facets module 1.0.0. Provides `search.facets`. Facet identity is `(store_id, name, value)` counted from catalog attribute maps exposed by `catalog.query`.
