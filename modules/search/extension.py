...
_PUBLIC_SPEC = importlib.util.spec_from_file_location("plaik_pkg_search_public", Path(__file__).with_name("storefront_public.py"))
...
def register(runtime: ExtensionRuntime) -> None:
    ...
    register_public(runtime, SearchQuery(engine))
