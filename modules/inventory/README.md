...
Official PLAIK inventory module 1.0.1. Provides `inventory.stock`. Stock identity is `(store_id, product_id)` where `product_id` is the catalog `ResourceRef.id` string.
