...
Official PLAIK checkout module 1.0.0. Provides `checkout.place`. Place is an orchestrator: it quotes the cart, applies an optional coupon, quotes shipping, adjusts inventory, snapshots the order, captures a manual payment, marks the order paid, and clears the cart.
