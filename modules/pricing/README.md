...
Official PLAIK pricing module 1.0.0. Provides `pricing.list`. List-price identity is `(store_id, product_id)` where `product_id` is the catalog `ResourceRef.id` string.
